...
class LinkManager(models.Manager):
    ...
    def ogc_wms(self):
        return self.get_queryset().filter(link_type='OGC:WMS').all()

    def ogc_wfs(self):
        return self.get_queryset().filter(link_type='OGC:WFS').all()

    def ogc_wcs(self):
        return self.get_queryset().filter(link_type='OGC:WCS').all()

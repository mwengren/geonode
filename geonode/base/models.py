...
class LinkManager(models.Manager):
    ...
    def ogc_wms(self):
        return self.get_queryset().filter(link_type__in=['OGC:WMS'])

    def ogc_wfs(self):
        return self.get_queryset().filter(link_type__in=['OGC:WFS'])

    def ogc_wcs(self):
        return self.get_queryset().filter(link_type__in=['OGC:WCS'])
